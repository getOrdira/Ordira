  ...
  ({ toast, onDismiss, position, className, ...props }, ref) => {
    ...
    const getIcon = () => {
      ...
      switch (toast.variant) {
        ...
        case 'info':
        default:
          return <InformationCircleIcon className={cn(iconClass, "text-[var(--accent)]")} />;
      }
    };
    ...
    const getActionButtonClass = (variant?: string) => {
      ...
      switch (variant) {
        case 'primary':
          return cn(baseClass, "bg-[var(--accent)] text-white hover:bg-[var(--accent-dark)]");
        case 'secondary':
          return cn(baseClass, "bg-gray-100 text-[var(--dark)] hover:bg-gray-200");
        case 'outline':
        default:
          return cn(baseClass, "border border-gray-300 text-[var(--dark)] hover:bg-gray-50");
      }
    };
          ...
          <div className="flex items-start justify-between mb-1">
            <div className="min-w-0 flex-1">
              <div className="flex items-center space-x-2">
                <span className={cn(
                  ...
                  toast.variant === 'info' && "text-[var(--accent)]"
                )}>
                  {getVariantLabel()}
                </span>
              </div>
              
              <h3 className="text-sm font-semibold text-[var(--dark)] mt-1 line-clamp-2">
                {toast.title}
              </h3>
            </div>
            ...
            {toast.dismissible !== false && (
              <button
                ...
                className="ml-2 p-1 text-[var(--muted)] hover:text-[var(--dark)] hover:bg-gray-100 rounded-lg transition-colors flex-shrink-0"
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-200 rounded-b-2xl overflow-hidden">
            <div 
              className={cn(
                ...
                toast.variant === 'info' && "bg-[var(--accent)]"
              )}
              style={{
