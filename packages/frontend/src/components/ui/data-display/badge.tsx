...
const avatarVariants = cva(
  // Base styles
  "relative inline-flex items-center justify-center overflow-hidden bg-gray-100 select-none",
  {
    variants: {
      size: {
        xs: "w-6 h-6 text-xs",
      ...
      <div className="relative inline-block">
        <div
          ...
          className={cn(
            ...
            uploadError && "ring-2 ring-red-500 ring-offset-2",
            className
          )}
          {...props}
        >
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="inline-flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {showRemoveButton && currentImageUrl && onRemove && (
              <button
                ...
                disabled={isUploading || uploading}
                className="inline-flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
