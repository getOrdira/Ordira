      ...
      >
        ...
        <div className="px-4 py-3 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <h3 className="font-medium text-[var(--dark)]">Notifications</h3>
            {unreadCount > 0 && (
              <button
        ...
        {notifications.length > 0 && (
          <>
            ...
            <button
              onClick={onViewAll}
              className="w-full px-4 py-3 text-sm text-[var(--accent)] hover:bg-gray-50 transition-colors text-center font-medium"
            >
