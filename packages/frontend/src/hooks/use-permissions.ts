...
const RESOURCE_ACCESS: Record<string, UserRole[]> = {
  'admin': ['brand'], // Admin functionality available to brand users
  'brand-dashboard': ['brand'],
  'manufacturer-dashboard': ['manufacturer'],
  'customer-dashboard': ['customer'],
  'analytics': ['brand', 'manufacturer'],
  'settings': ['brand', 'manufacturer'],
  'billing': ['brand', 'manufacturer'],
  'users': ['brand', 'manufacturer'],
  'integrations': ['brand', 'manufacturer'],
  'domains': ['brand', 'manufacturer'],
  'products': ['brand', 'manufacturer', 'customer'],
  'certificates': ['brand', 'manufacturer', 'customer'],
  'votes': ['brand', 'manufacturer', 'customer'],
};
