...
import { validateParams, validateQuery, validateBody } from '../../middleware/deprecated/validation.middleware';
...
import * as notificationCtrl from '../../controllers/deprecated/notification.controller';
import {
