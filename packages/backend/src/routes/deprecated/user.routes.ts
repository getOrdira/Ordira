...
import { authenticate, requireUser } from '../../middleware/deprecated/unifiedAuth.middleware';
import { dynamicRateLimiter, strictRateLimiter } from '../../middleware/deprecated/rateLimiter.middleware';
import { metricsMiddleware, trackManufacturerAction } from '../../middleware/deprecated/metrics.middleware';
import { uploadMiddleware, cleanupOnError } from '../../middleware/deprecated/upload.middleware';
import * as userCtrl from '../../controllers/deprecated/user.controller';
import {
  registerUserSchema,
  loginUserSchema,
  verifyUserSchema,
