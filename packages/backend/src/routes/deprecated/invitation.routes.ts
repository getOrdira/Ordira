...
import { authenticate, UnifiedAuthRequest, requireManufacturer } from '../../middleware/deprecated/unifiedAuth.middleware';
...
import * as invCtrl from '../../controllers/deprecated/invitation.controller';
import {
  sendInviteSchema,
