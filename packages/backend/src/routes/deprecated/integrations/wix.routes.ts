...
import { authenticate, UnifiedUnifiedAuthRequest } from '../../../middleware/deprecated/unifiedAuth.middleware';
...
import * as wixCtrl from '../../../controllers/deprecated/wix.controller';
import Joi from 'joi';
