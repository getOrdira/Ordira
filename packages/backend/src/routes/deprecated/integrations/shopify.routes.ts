...
import { validateBody, validateQuery, validateParams, ValidatedRequest } from '../../../middleware/deprecated/validation.middleware';
...
import * as shopifyCtrl from '../../../controllers/deprecated/shopify.controller';
import Joi from 'joi';
