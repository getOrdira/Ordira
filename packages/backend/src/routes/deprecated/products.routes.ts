...
import { authenticate, requireVerifiedManufacturer } from '../../middleware/deprecated/unifiedAuth.middleware';
import { resolveTenant } from '../../middleware/deprecated/tenant.middleware';
...
import * as productCtrl from '../../controllers/deprecated/product.controller';
import {
  createProductSchema,
  updateProductSchema,
...
import Joi from 'joi';
import * as supplyChainCtrl from '../../controllers/deprecated/supplyChain.controller';
