...
import { authenticate, requireBusiness } from '../../middleware/deprecated/unifiedAuth.middleware';
import { resolveTenant, requireTenantPlan } from '../../middleware/deprecated/tenant.middleware';
...
import * as settingsCtrl from '../../controllers/deprecated/brandSettings.controller';
import {
