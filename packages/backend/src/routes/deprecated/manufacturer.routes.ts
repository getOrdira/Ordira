...
import Joi from 'joi';
import { validateBody, validateParams, validateQuery } from '../../middleware/deprecated/validation.middleware';
import { asRouteHandler, asRateLimitHandler } from '../../utils/routeHelpers';
import { authenticate, requireVerifiedManufacturer, requireManufacturer } from '../../middleware/deprecated/unifiedAuth.middleware';
...
import * as mfgCtrl from '../../controllers/deprecated/manufacturer.controller';
import * as mfgAccountCtrl from '../../controllers/deprecated/manufacturerAccount.controller';
import * as supplyChainDashboardCtrl from '../../controllers/deprecated/supplyChainDashboard.controller';
import {
