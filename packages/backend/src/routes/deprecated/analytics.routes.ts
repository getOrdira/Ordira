...
import { validateQuery, validateParams, validateBody } from '../../middleware/deprecated/validation.middleware';
...
import * as analyticsCtrl from '../../controllers/deprecated/analytics.controller';
import Joi from 'joi';
