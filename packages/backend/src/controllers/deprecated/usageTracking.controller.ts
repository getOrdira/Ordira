...
import {
  ...
  UsageLimits,
  UsageCheck
} from '../../services/business/usageTracking.service';
...
export const getUsageLimits = asyncHandler(async (
  ...
  try {
    ...
    const usageLimits = await usageTrackingService.getUsageLimits(businessId, true);
...
export const checkUsageLimits = asyncHandler(async (
  ...
  try {
    ...
    const checkResult = await usageTrackingService.checkLimits(businessId, operation, amount);
...
export const updateUsage = asyncHandler(async (
  ...
  try {
    ...
    await usageTrackingService.updateUsage(businessId, usageUpdate, immediate);
...
export const getUsageAnalytics = asyncHandler(async (
  ...
  try {
    ...
    const analytics = await usageTrackingService.getUsageAnalytics(businessId, days);
...
export const resetMonthlyUsage = asyncHandler(async (
  ...
  try {
    ...
    const currentUsage = await usageTrackingService.getUsageLimits(businessId, false);

    // Perform reset
    await usageTrackingService.resetMonthlyUsage(businessId);
