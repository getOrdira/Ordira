...
import { optimizedVotingService } from '../services/business/optimized-votes.service';
...
export const getVotingAnalytics = asyncHandler(async (
  ...
  try {
    ...
    const analytics = await optimizedVotingService.getOptimizedVotingAnalytics(businessId, options);
...
export const getVotingStats = asyncHandler(async (
  ...
  try {
    ...
    const stats = await optimizedVotingService.getOptimizedVotingStats(businessId, useCache);
...
export const getBusinessVotes = asyncHandler(async (
  ...
  try {
    ...
    const votes = await optimizedVotingService.getOptimizedBusinessVotes(businessId, {
      useCache,
      limit,
      offset,
      sortBy,
...
export const getPendingVotes = asyncHandler(async (
  ...
  try {
    ...
    const pendingVotes = await optimizedVotingService.getOptimizedPendingVotes(businessId, {
      proposalId,
      userId,
      limit,
      offset,
...
export const getBusinessProposals = asyncHandler(async (
  ...
  try {
    ...
    const proposals = await optimizedVotingService.getOptimizedBusinessProposals(businessId, {
      useCache,
      searchQuery,
      status,
      limit
...
export const getVotingDashboard = asyncHandler(async (
  ...
  try {
    ...
    const dashboard = await optimizedVotingService.getVotingDashboard(businessId);
...
export const clearVotingCache = asyncHandler(async (
  ...
  try {
    ...
    await optimizedVotingService.clearVotingCaches(businessId);
...
export const healthCheck = asyncHandler(async (
  ...
  try {
    const health = await optimizedVotingService.getVotingServiceHealth();
...
export const optimizedVotesController = {
  getVotingAnalytics,
  getVotingStats,
  getBusinessVotes,
  getPendingVotes,
