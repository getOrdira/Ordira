...
import { optimizedProductService } from '../services/business/optimized-product.service';
import { optimizedAnalyticsService } from '../services/business/optimized-analytics.service';
...
export const getProducts = asyncHandler(async (
  ...
  try {
    ...
    const result = await optimizedProductService.getProducts(filters);
...
export const getProduct = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const product = await optimizedProductService.getProduct(id, userContext.businessId, userContext.manufacturerId);
    ...
    const analytics = await optimizedProductService.getProductAnalytics(
...
export const createProduct = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const product = await optimizedProductService.createProduct(
      productData,
      userContext.businessId,
      userContext.manufacturerId
    );
...
export const updateProduct = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const product = await optimizedProductService.updateProduct(
      id,
      updates,
      userContext.businessId,
      userContext.manufacturerId
...
export const deleteProduct = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    await optimizedProductService.deleteProduct(
      id,
      userContext.businessId,
      userContext.manufacturerId
    );
...
export const searchProducts = asyncHandler(async (
  ...
  try {
    const userContext = getUserContext(req as UnifiedAuthRequest);
    const searchParams = req.validatedBody;

    // Use optimized search
    const result = await optimizedProductService.searchProducts({
