 ...
 *
 * This controller demonstrates how to leverage optimized manufacturer services:
...
import { optimizedManufacturerService } from '../services/business/optimized-manufacturer.service';
...
export const registerManufacturer = asyncHandler(async (
  ...
  try {
    ...
    const manufacturer = await optimizedManufacturerService.registerManufacturer(manufacturerData);
...
export const loginManufacturer = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const result = await optimizedManufacturerService.loginManufacturer(email, password);
...
export const searchManufacturers = asyncHandler(async (
  ...
  try {
    ...
    const result = await optimizedManufacturerService.searchManufacturers(params);
...
export const getManufacturerProfile = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const manufacturer = await optimizedManufacturerService.getManufacturerById(id, true);
    ...
    if (includeAnalytics) {
      analytics = await optimizedManufacturerService.getManufacturerAnalytics(id);
    }
...
export const updateManufacturerProfile = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const manufacturer = await optimizedManufacturerService.updateManufacturerProfile(manufacturerId, updates);
...
export const getManufacturersByIndustry = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const manufacturers = await optimizedManufacturerService.getManufacturersByIndustry(industry, limit);
...
export const getManufacturerAnalytics = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const analytics = await optimizedManufacturerService.getManufacturerAnalytics(manufacturerId, dateRange);
...
export const deleteManufacturer = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    await optimizedManufacturerService.deleteManufacturer(manufacturerId);
