 ...
 *
 * This controller demonstrates how to leverage optimized media services:
...
import { optimizedMediaService, MediaUploadOptions, MediaListOptions } from '../services/business/optimized-media.service';
...
export const uploadMedia = asyncHandler(async (
  ...
  try {
    ...
    const media = await optimizedMediaService.saveMedia(file, uploaderId, options);
...
export const uploadBatchMedia = asyncHandler(async (
  ...
  try {
    ...
    const result = await optimizedMediaService.saveMultipleMedia(files, uploaderId, options);
...
export const listMedia = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const result = await optimizedMediaService.listMediaByUser(uploaderId, options);
...
export const getMedia = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const media = await optimizedMediaService.getMediaById(id, uploaderId, true);
...
export const searchMedia = asyncHandler(async (
  ...
  try {
    ...
    const result = await optimizedMediaService.searchMedia(uploaderId, query, options);
...
export const getStorageStats = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const stats = await optimizedMediaService.getStorageStatistics(uploaderId);
...
export const getMediaByCategory = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const media = await optimizedMediaService.getMediaByCategory(uploaderId, category as any);
...
export const getRecentMedia = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const media = await optimizedMediaService.getRecentMedia(uploaderId, limit);
...
export const deleteMedia = asyncHandler(async (
  ...
  try {
    ...
    // Use optimized service
    const result = await optimizedMediaService.deleteMedia(id, uploaderId);
