 ...
 */
export class OptimizedUsageTrackingService {
...
export const optimizedUsageTrackingService = new OptimizedUsageTrackingService();

// Graceful shutdown handling
process.on('SIGTERM', () => {
  optimizedUsageTrackingService.cleanup();
});
