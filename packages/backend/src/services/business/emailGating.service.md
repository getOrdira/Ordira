/**
 * @deprecated This service has been migrated to the brands module.
 * Please use CustomerAccessService from '@/services/brands/features/customerAccess.service' instead.
 *
 * Migration path:
 * - EmailGatingService → CustomerAccessService
 * - Located at: services/brands/features/customerAccess.service.ts
 * - Import: import { customerAccessService } from '@/services/brands';
 *
 * This file will be removed in a future version.
 * @see services/brands/features/customerAccess.service.ts
 */

// src/services/business/emailGating.service.ts (DEPRECATED - Use brands/features/customerAccess.service.ts)
