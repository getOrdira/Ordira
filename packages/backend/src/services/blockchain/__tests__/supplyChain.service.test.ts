...
describe('SupplyChainService', () => {
  ...
  beforeEach(() => {
    ...
    MockedBlockchainProviderService.getContract.mockReturnValue(mockSupplyChainContract as any);
    ...
    describe('createEndpoint', () => {
      ...
      it('should validate business contract association', async () => {
        ...
        await expect(SupplyChainService.createEndpoint(
          ...
          statusCode: 404,
          message: 'No supply chain contract deployed for this business'
        });
      });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle contract association mismatch', async () => {
      ...
      await expect(SupplyChainService.createEndpoint(
        ...
        statusCode: 403,
        message: 'Contract address does not match business association'
      });
    });
  });
