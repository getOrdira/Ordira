  ...
  beforeEach(() => {
    ...
    const mockVotingContract = {
      ...
      proposals: jest.fn().mockResolvedValue({
        ...
        endTime: BigInt(Date.now() / 1000 + 259200),
    ...
    MockedBlockchainProviderService.getContract.mockReturnValue(mockVotingContract as any);
    ...
    const mockVoteEvents = [
      {
        args: { voteId: '12345', voter: '0x1111111111111111111111111111111111111111', proposalId: BigInt(1) },
        transactionHash: '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890',
        blockNumber: 12345
      }
    ];
    
    mockVotingContract.queryFilter.mockResolvedValueOnce(mockProposalEvents as any);
    mockVotingContract.queryFilter.mockResolvedValueOnce(mockVoteEvents as any);
  ...
  describe('Error Handling', () => {
    ...
    it('should handle call exceptions', async () => {
      ...
      await expect(VotingService.createProposal(
        ...
        statusCode: 404,
        message: 'Voting contract call failed - contract may not exist or method unavailable'
      });
    });
